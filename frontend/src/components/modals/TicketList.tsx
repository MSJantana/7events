...
export default function TicketList({ tickets, selectedTT, onSelectTT, highlightIds }: Readonly<{ tickets: TicketType[]; selectedTT: string; onSelectTT: (id: string) => void; highlightIds: string[] }>) {
  return (
