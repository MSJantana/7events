...
type Props = { endDate?: string; status?: EventStatus; style?: CSSProperties; className?: string }

export default function FinalizadoBadge({ endDate, status, style, className }: Props) {
